function enrollGamesHandler(req, res) {
   ...
   // var userID=1;
    ...
    console.log("Amount:"+req.body.amount+" user_id:"+userID+" owner_id:"+req.body.owner_id+" game_id:"+req.body.game_id);
    mysql_helper.executeQuery(query,[req.body.amount, userID,req.body.owner_id, req.body.game_id]).then((result) => {
